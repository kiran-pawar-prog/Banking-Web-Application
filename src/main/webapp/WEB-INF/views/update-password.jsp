...
<body>
		...
		<div class="container text-center h-100">
			<div class="row h-100 align-items-center">
				<div
					...
					<form action="update-pass-validate"
						...
						<div class="alert alert-danger alert-dismissible fade show"
							...
							<strong style="font-size: 16px"><i
								class="bi bi-exclamation-triangle-fill" style="font-size: 20px"></i>  ${failed }</strong>
							<button type="button" class="btn-close" data-bs-dismiss="alert"
								aria-label="Close"></button>
						</div>
					</c:if>
						<h3 class="text-dark fw-bolder fs-4 mb-3">Update Your
							Password</h3>

						<div class="form-floating mb-3">
							<input type="password" class="form-control" id="currentPass"
								placeholder="Current Password" required name="currentPass">
						...
						<div class="form-floating mb-3">
							<input type="password" class="form-control" id="password"
								...
								name="password"> <label for="password">New
								Password</label>
						...
						<button type="submit"
							class="btn btn-primary mt-3 py-2 px-4 sub_or_cancel">Setup</button>
						<a href="main-page"
	...
	<!-- JS Path -->
	<script
		src="http://localhost:8080/BankingWebApp/assets/js/update-password.js"></script>
